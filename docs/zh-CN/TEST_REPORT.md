...
> 视频播放器包的完整测试报告，包含单元测试、集成测试和浏览器测试结果
...
- **测试包版本**: @dreamer/test@^1.0.0-beta.13
...
**注意**: 此测试套件需要在真实浏览器环境中运行，使用 Puppeteer 控制
Chrome/Chromium。
...
@dreamer/video-player 包经过全面测试，所有 103 个测试全部通过，测试覆盖率达到
100%。

**测试总数**: 103

**可以放心用于生产环境**。 **项目版本**: @dreamer/video-player@^1.0.0-beta.1
